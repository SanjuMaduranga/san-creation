        ...
        <div className="flex flex-col md:flex-row bg-gray-800 rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="w-full md:w-1/2 p-6 md:p-8">
            <p className="text-gray-300 mb-6 leading-relaxed text-sm md:text-base">
              SAN Creation was born from a passion for creativity, design, and helping businesses bring their brand to life through impactful visuals.
              Founded by a dedicated graphic designer with years of experience in branding, logo design, and digital art, SAN Creation has grown into a trusted name in the creative industry. Our journey began with a simple mission: to create designs that resonate and tell a story.
            </p>
            <p className="text-gray-300 leading-relaxed text-sm md:text-base">
              Over the years, we’ve worked with a wide variety of clients, from startups to established businesses, helping them find their unique visual identity. At SAN Creation, we believe that good design is about more than just aesthetics—it’s about conveying the right message and creating lasting impressions.
            </p>
          </div>
        </div>
